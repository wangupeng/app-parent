...
<meta charset="utf-8"/>
<title>图标</title>
<link rel="stylesheet" href="${staticServer}/static/lib/Hui-iconfont/1.0.8/iconfont.css"/>
    <style type="text/css">
        .Hui-article h1{font-size:36px; line-height:1.6; color:#333; text-align:center;margin-bottom:30px; font-weight:normal}
        .Hui-article h2{ font-size:24px;line-height:1.6;color:#333;margin-bottom:30px; border-bottom: 1px solid #eee; font-weight:normal}
        .helps { margin-top: 0px}
...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="${staticServer}/index" class="maincolor">首页</a>
        ...
        <span class="c-gray en">&gt;</span> 图标示例
